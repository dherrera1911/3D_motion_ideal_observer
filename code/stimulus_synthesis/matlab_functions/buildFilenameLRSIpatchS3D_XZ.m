function fname = buildFilenameLRSIpatchS3D(natORflt, numImg, stmPerLvlDTB, PszXY, projInfo, lensInfo, ...
  sensInfo, wndwInfo, bPreWndw, imgDim, dnK, spdMeterPerSec, spdDirDeg, stmPerLvl, rndSdInfo, trnORtst)
...
fname = ['LRSI_S3D_'  natORflt '_' num2str(numImg,'%03d') '_' num2str(stmPerLvlDTB,'%04d') '_' ...
         num2str(PszXY(1),'%03d'), 'x' num2str(PszXY(2),'%03d') ...
         '_' num2str(PszXY(1)./dnK,'%03d'), 'x' num2str(PszXY(2)./dnK,'%03d') ...
         '_' imgDim  ...
         '_' num2str(min(spdMeterPerSec),'%+.3f\n') '_' num2str(max(spdMeterPerSec),'%+.3f\n') ...
         '_' num2str(length(spdMeterPerSec),'%02d') 'Spdlvl' ...
         '_' num2str(length(spdDirDeg),'%02d') 'Dirlvl' ...
         '_' num2str(stmPerLvl, '%04d') 'stmPerLvl' ...
         '_' projInfo.projStr ...
         '_' sensInfo.sensStr ...
         '_' wndwInfo.wndwStr ...
         '_W',num2str(bPreWndw) ...
         '_' lensInfo.lensStr ...
         '_rSd' num2str(rndSdInfo.rndSdCP) num2str(rndSdInfo.rndSdGD) num2str(rndSdInfo.rndSdTT) ...
         '_' trnORtst '.mat'];
